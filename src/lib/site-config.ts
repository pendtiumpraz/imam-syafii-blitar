...
export function getDefaultNavbarItems(): NavbarItem[] {
  return [
    ...
    },
    {
      ...
      order: 2,
      children: [
        { id: '2-1', label: 'Yayasan', href: '/about/yayasan', order: 1 },
        { id: '2-2', label: 'Struktur Organisasi', href: '/about/struktur', order: 2 },
        { id: '2-3', label: 'Ustadz & Ustadzah', href: '/about/pengajar', order: 3 },
        { id: '2-4', label: 'Pondok Pesantren', href: '/about/pondok', order: 4 },
        { id: '2-5', label: 'TK Islam', href: '/about/tk', order: 5 },
