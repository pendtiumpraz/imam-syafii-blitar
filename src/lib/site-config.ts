    ...
    },
    {
      ...
      children: [
        ...
        { id: '2-4', label: 'Keunggulan', href: '/about/keunggulan', order: 4 },
        {
          ...
          order: 5,
          children: [
            { id: '2-5-1', label: 'KB-TK Islam', href: '/about/tk', order: 1 },
            { id: '2-5-2', label: 'SD Islam', href: '/about/sd', order: 2 },
            { id: '2-5-3', label: 'SMP Pesantren', href: '/about/smp', order: 3 },
            { id: '2-5-4', label: 'SMA Pesantren', href: '/about/sma', order: 4 },
            { id: '2-5-5', label: 'Pondok Pesantren', href: '/about/pondok', order: 5 },
          ]
        },
        { id: '2-6', label: 'Beasiswa', href: '/about/beasiswa', order: 6 },
        { id: '2-7', label: 'Ustadz & Ustadzah', href: '/about/pengajar', order: 7 },
        { id: '2-8', label: 'Struktur Organisasi', href: '/about/struktur', order: 8 },
      ],
    },
    {
      id: '3',
