...
const StudentImportSchema = z.object({
  ...
  religion: z.string().default('Islam').nullable().optional(),
  nationality: z.string().default('Indonesia').nullable().optional(),
  address: z.string().min(1, 'Alamat wajib diisi'),
  village: z.string().optional().nullable(),
  district: z.string().optional().nullable(),
  city: z.string().min(1, 'Kota wajib diisi'),
  province: z.string().default('Jawa Timur').nullable().optional(),
        ...
        if (preview) {
          ...
          const newStudent = await prisma.students.create({
            data: {
              ...
              nationality: validatedData.nationality || 'Indonesia',
              address: validatedData.address,
              village: validatedData.village,
              district: validatedData.district,
              city: validatedData.city,
              province: validatedData.province || 'Jawa Timur',
